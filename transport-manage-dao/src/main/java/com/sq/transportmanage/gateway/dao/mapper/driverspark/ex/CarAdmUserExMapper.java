...
public interface CarAdmUserExMapper {
	/**根据账户查询**/
    CarAdmUser queryByAccount(@Param("account") String account,@Param("merchantIds")String merchantIds);
    /**查询用户列表**/
    List<CarAdmUser> queryUsers(@Param("merchantIds")String merchantIds,@Param("userIds") List<Integer> userIds, @Param("account") String account, @Param("userName") String userName, @Param("phone") String phone, @Param("status") Integer status);
