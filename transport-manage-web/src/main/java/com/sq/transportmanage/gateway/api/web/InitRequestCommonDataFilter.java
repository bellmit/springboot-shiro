...
import com.sq.transportmanage.gateway.api.util.NumberUtil;
...
@Configuration
@Order(value = 0)
@WebFilter(filterName = "initRequestCommonDataFilter", urlPatterns = "/*")
...
//        }
        ...
        request.setAttribute("ssoLogoutUrl", "https://test-inside-sso.01zhuanche.com/logout" );
        request.setAttribute("cmsLogoutUrl", "http://dev-inside-mp-scos-manage.01zhuanche.com/logout.html" );
