...
public class IPv4Util2 {
	private static final Logger logger = LoggerFactory.getLogger(IPv4Util2.class);
	...
	public static String intToIp(int ipInt) {
		return new StringBuilder().append(((ipInt >> 24) & 0xff)).append('.').append((ipInt >> 16) & 0xff).append('.').append((ipInt >> 8) & 0xff).append('.')
