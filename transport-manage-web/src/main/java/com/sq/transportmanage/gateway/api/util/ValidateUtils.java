...
public class ValidateUtils {
    ...
    public static Integer getGender(Boolean bool, String idCard) {
        try {
            ...
            String vali = "";
            if (bool) {
                vali = ValidateUtils.IDCardValidate(idCard);
            }

            if (StringUtils.isBlank(vali)) {
                String sub = idCard.substring(idCard.length() - 1, idCard.length());
    ...
    public static String getBirthday(Boolean bool, String idCard) {
        try {
            if (StringUtils.isBlank(idCard)) {
                return null;
            }
