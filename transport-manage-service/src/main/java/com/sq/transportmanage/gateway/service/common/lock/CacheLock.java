package com.sq.transportmanage.gateway.service.common.lock;
...
public class CacheLock {
     ...
     * @return
     */
    public static boolean setLock(String key, String value, Long expire) {
        try {
    ...
    @Resource(name = "ncdsRedisTemplate")
