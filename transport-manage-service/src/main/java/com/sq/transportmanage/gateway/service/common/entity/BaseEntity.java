package com.sq.transportmanage.gateway.service.common.entity;
...
public class BaseEntity implements Serializable{
	...
	/**
	 * @Id  目前这个需要迁移注解,主要这个项目运用了pagehelper的分页,针对业务迁移逐步去换方式满足
	 */
	private Integer id;
	...
	public Integer getCrossOffSet() {
		return crossOffSet;
	}
	public void setCrossOffSet(Integer crossOffSet) {
